...
This is the readme for eldoria, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. Eldoria) > Ok.
...
- To run the project find Eldoria.java (which will be in under src/main/java/io/github/bbortt/eldoria) and right click > Run 'Eldoria'
